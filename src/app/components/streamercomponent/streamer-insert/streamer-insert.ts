...
@Component({
  selector: 'app-streamer-insert',
  imports: [
    MatInputModule, MatFormFieldModule,
    MatButtonModule, MatIconModule, MatSelectModule,
    MatDatepickerModule, MatNativeDateModule,
    MatProgressSpinnerModule, ReactiveFormsModule, CommonModule
  ],
  templateUrl: './streamer-insert.html',
  providers: [provideNativeDateAdapter()],
  styleUrl: './streamer-insert.css',
})
export class StreamerInsert implements OnInit {
